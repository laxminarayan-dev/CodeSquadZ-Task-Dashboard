              ...
              <div className={`p-5 h-[inherit]`}>
                ...
                <div className="relative flex gap-2 h-10">
                  <button
                    ...
                    className={`border border-violet-300 rounded-2xl flex-1 flex items-center justify-center gap-2 text-xs font-medium text-slate-700 px-3 py-2 z-20 hover:bg-violet-500 hover:text-slate-50 cursor-pointer`}
                  >
